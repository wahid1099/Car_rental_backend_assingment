...
router.get("/", (0, auth_1.default)(user_constant_1.USER_ROLE.admin), car_controller_1.CarControllers.getAllCars);
router.get("/:id", (0, auth_1.default)(user_constant_1.USER_ROLE.admin), car_controller_1.CarControllers.getSingleCar);
